...
x_train = tl.files.load_file_list(path=training_data_path,
                                      regx='.*.mat',
                                      printable=False)
...
mask_train = tl.files.load_file_list(path=training_mask_path,
                                      regx='.*.mat',
                                      printable=False)
mask_train.sort(key=tl.files.natural_keys)
x_val = tl.files.load_file_list(path=val_data_path,
                                      regx='.*.mat',
                                      printable=False)
x_val.sort(key=tl.files.natural_keys)

y_val = tl.files.load_file_list(path=val_gooddata_path,
                                      regx='.*.mat',
                                      printable=False)
y_val.sort(key=tl.files.natural_keys)

mask_val = tl.files.load_file_list(path=val_mask_path,
                                      regx='.*.mat',
                                      printable=False)
mask_val.sort(key=tl.files.natural_keys)
